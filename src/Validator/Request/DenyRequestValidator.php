...
class DenyRequestValidator
{
    ...
    public function requireConditionGroups(?array $value): self
    {
        if (!is_array($value) && (is_array($value) && 0 !== count($value))) {
            $this->errors[] = 'Parameter conditionGroups is required and must be an integer';
        }
