...
class AvailabilityRuleTest extends KernelTestCase
{
    ...
    public static function dataProviderForTestRule(): Generator
    {
        ...
        yield 'CASE #03, applicable, outside allowed weekdays' => [
            'throwsException' => true,
            'params' => [
                'startsAt' => DateSmith::withDateAndTime(2000, 1,1,20, 0),
                'endsAt' => DateSmith::withDateAndTime(2000, 1,1,21, 0),
                'spaceId' => 1,
                'userId' => 1,
                'rules' => [
                    $ruleSmith->parse(
                        type: RuleType::AVAILABILITY,
                        rule: '{"daysBitmask":0,"start":0,"end":1440,"spaceIds":null}',
                    ),
                ],
            ],
        ];
        ...
        yield 'CASE #05, no space match, not applicable' => [
            ...
            'params' => [
                ...
                'rules' => [
                    $ruleSmith->parse(
                        type: RuleType::AVAILABILITY,
                        rule: '{"daysBitmask":1,"start":0,"end":0,"spaceIds":[2,3]}',
                    ),
                ],
            ],
        ];
