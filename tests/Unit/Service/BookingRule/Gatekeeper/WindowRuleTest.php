...
class WindowRuleTest extends KernelTestCase
{
    ...
    public static function dataProviderForTestRule(): Generator
    {
        ...
        yield 'CASE #01, applicable, predicate 1, violating' => [
            ...
            'params' => [
                'startsAt' => (clone $today)->modify('+5 hours')->format(TimeRange::DATETIME_FORMAT),
                'endsAt' => (clone $today)->modify('+6 hours')->format(TimeRange::DATETIME_FORMAT),
                'spaceId' => 1,
                'userId' => 1,
                'rules' => [
                    $ruleSmith->parse(
        ...
        yield 'CASE #02, applicable, predicate 1, no exception' => [
            ...
            'params' => [
                'startsAt' => (clone $today)->modify('+50 hours')->format(TimeRange::DATETIME_FORMAT),
                'endsAt' => (clone $today)->modify('+51 hours')->format(TimeRange::DATETIME_FORMAT),
                'spaceId' => 1,
                'userId' => 1,
                'rules' => [
                    $ruleSmith->parse(
        ...
        yield 'CASE #03, applicable, predicate 2, no exception' => [
            'throwsException' => false,
            'params' => [
                'startsAt' => (clone $today)->modify('+120 minutes')->format(TimeRange::DATETIME_FORMAT),
                'endsAt' => (clone $today)->modify('+180 minutes')->format(TimeRange::DATETIME_FORMAT),
                'spaceId' => 1,
                'userId' => 1,
                'rules' => [
                    $ruleSmith->parse(
        ...
        yield 'CASE #04, applicable, predicate 2, exception' => [
            'throwsException' => true,
            'params' => [
                'startsAt' => (clone $today)->modify('+10 minutes')->format(TimeRange::DATETIME_FORMAT),
                'endsAt' => (clone $today)->modify('+40 minutes')->format(TimeRange::DATETIME_FORMAT),
                'spaceId' => 1,
                'userId' => 1,
                'rules' => [
                    $ruleSmith->parse(
        ...
        yield 'CASE #06, applicable, predicate 3, exception' => [
            'throwsException' => true,
            'params' => [
                'startsAt' => (clone $today)->modify('+3000 minutes')->format(TimeRange::DATETIME_FORMAT),
                'endsAt' => (clone $today)->modify('+3060 minutes')->format(TimeRange::DATETIME_FORMAT),
                'spaceId' => 1,
                'userId' => 1,
                'rules' => [
                    $ruleSmith->parse(
        ...
        yield 'CASE #07, not applicable, no space match' => [
            ...
            'params' => [
                'startsAt' => (clone $today)->modify('+10 minutes')->format(TimeRange::DATETIME_FORMAT),
                'endsAt' => (clone $today)->modify('+20 minutes')->format(TimeRange::DATETIME_FORMAT),
                'spaceId' => 1,
                'userId' => 1,
                'rules' => [
                    $ruleSmith->parse(
        ...
        yield 'CASE #08, not applicable, no user role match' => [
            'throwsException' => false,
            'params' => [
                'startsAt' => (clone $today)->modify('+61 minutes')->format(TimeRange::DATETIME_FORMAT),
                'endsAt' => (clone $today)->modify('+90 minutes')->format(TimeRange::DATETIME_FORMAT),
                'spaceId' => 1,
                'userId' => 1,
                'rules' => [
                    $ruleSmith->parse(
